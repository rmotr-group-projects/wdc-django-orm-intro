...
def task_4_artists_create_song():
    ...
    Song.objects.create(artist_id=artist.id,title="BB's Song", album_name="B.B. King Hits")
...
def task_6_song_edit_album():
    ...
    album_update = Song.objects.get(title='Superstition')
    album_update.album_name = "any other name"
    album_update.save()
